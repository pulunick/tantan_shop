<script lang="ts">
	/** 새 시공사례 등록. 이미지는 등록 후 상세(수정) 화면에서 추가한다. */
...
<h1 class="mb-6 text-[24px] font-black tracking-tight text-ink">새 시공사례 등록</h1>
