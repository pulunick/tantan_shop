...
<h1 class="mb-6 text-[24px] font-black tracking-tight text-ink">새 공지 등록</h1>
	...
	<div class="flex flex-wrap gap-6">
		<label class="flex min-h-11 cursor-pointer items-center gap-2 text-[15px] font-bold text-ink">
			<input
				type="checkbox"
				name="is_pinned"
				checked={form?.values?.is_pinned ?? false}
